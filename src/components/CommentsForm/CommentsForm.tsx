        ...
        <div className="form__container">
          <div className="form__wrapper">
            <div className="comment__image-container">
              <img
                className="comment__image comment__image--form"
                src={avatar}
                alt="Mohan-muruge"
              />
            </div>
            ...
            <form className="form__comment" onSubmit={handleSubmit}>
              <div className="form__info-container">
                <label
                  className="form__comment-label form__comment-text--label"
                  htmlFor="comment"
                >
                  {" "}
                ...
                <textarea
                  ...
                  className={`form__comment-text form__comment-text${textFieldError}`}
                  id="comment"
                  name="comment"
              ...
              <div className="form__comment__btn-container">
                <button type="submit" className="form__comment-btn">
                  {" "}
                  COMMENT{" "}
                </button>
              </div>
