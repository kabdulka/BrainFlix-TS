      ...
      <section className="form__section">
        ...
        >
          <div className="form__section-thumbnail-container">
            ...
            <img
              className="form__section-thumbnail"
              src={fileDataUrl ? fileDataUrl : uploadThumbnail}
            />
            <div className="form__section__upload-container">
              <label
                className={`form__section__file-input ${
                  uploadErrorState.fileError ? "form__section__file--error" : ""
                }`}
              >
                {filename}
              </label>
          ...
          <div className="form__section-input">
            <div className="form__section-title-text">
              <label className="form__section-title-label" htmlFor="formTitle">
                {" "}
                TITLE YOUR VIDEO{" "}
              </label>
              <input
                ...
                className={`form__section-title-input ${
                  uploadErrorState.titleError
                    ? "form__section-title--error"
                    : ""
                }`}
                name="formTitle"
            ...
            <div className="form__section-description">
              <label
                className="form__section-description-label"
              ...
              <textarea
                ...
                className={`form__section-description-input ${
                  uploadErrorState.descriptionError
                    ? "form__section-description--error"
                    : ""
                }`}
        ...
        <div className="form__section-update">
          <button
            form="uploadForm"
            type="submit"
            className="form__section-publish"
          >
            PUBLISH
          </button>
